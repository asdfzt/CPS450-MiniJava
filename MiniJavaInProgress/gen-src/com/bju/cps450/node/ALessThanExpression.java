...
public final class ALessThanExpression extends PExpression
{
    private PExpression _lhs_;
    private PExpression _rhs_;

    public ALessThanExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessThanExpression(
    ...
    {
        ((Analysis) sw).caseALessThanExpression(this);
    }
